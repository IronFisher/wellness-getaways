...
const reviews = [
  { text: "The property is lovely, with everything in order and clean for a quick family get away. The kitchen is amazing, fully equipped with deluxe appliances. The layout worked out well with 2 living areas for our different ages to spread out. We had easy access to golfing and everything Lake Lure has to offer. The bedroom arrangement was ideal for us with children each in their own bed! It is a great property - I'd book again.", author: 'Anonymous', date: 'Verified Yonder guest · January 2026' },
  { text: "We heard about Lake Lure and Rumbling Bald from friends and went to check it out. Walking into this condo was a great start to the visit. The look is clean and modern, it was spacious, well-outfitted, the layout with two lounging areas was perfect, and what a kitchen! The bathrooms were nice and bright and beds seemed new – we slept well. We especially liked eating on the covered deck overlooking the golf course. We walked to all the facilities, which included restaurants, two lakes, pools and a well-equipped workout room. The resort had lots to do in addition to the golf course (putt-putt golf, hikes, and lake activities like kayaking, swimming). We will be returning for longer stays and will book this condo again.", author: 'Betty', date: 'Verified Yonder guest · May 2024' },
  { text: "I very much enjoyed my stay at the Lake Lure Getaway condo. While I could write pages about the memories friends and I made together during our stay, I'd be remiss if I didn't share about the beautiful space the owner has curated. Truly a cozy home away from home nestled in a safe, enchanting golf course community near the iconic Lake Lure. Owner's sense of design is elegant and every inch of the home is spotless and tidy. The space is modern and equipped with all the appliances you'll possibly need. You'll have access to amenities, restaurants, walking trails, and water activities at your back door. Oh and beautiful views of the Blue Ridge mountains out the front door! I would go back and stay in a heartbeat and highly recommend staying here for any amount of time!", author: 'Clinton', date: 'Verified Yonder guest · May 2024' },
  { text: "We are two couples who like to golf and love Rumbling Bald resort lifestyle. This place is by far the most modern we've stayed in. We loved it. The views, birdwatching and sounds of the creek in the quiet mornings are unbelievable. Everything was exceptional. I would say the only drawback is that the place is too modern. The nozzles and knobs on the showers were a bit intimidating at first. The oven also took a minute to figure out that it has separate upper/lower oven option. We listened to music on the giant TVs once we figured out the new style remotes and realized there were free music channels. We had a great time! Will be back and highly recommend this condo.", author: 'Kelly', date: 'Verified Yonder guest · May 2024' },
]
